# $FreeBSD: src/share/mk/bsd.libnames.mk,v 1.98 2006/03/20 14:24:57 ru Exp $
...
LIBSELINUX?=	${DESTDIR}${LIBDIR}/libselinux.a
LIBSEPOL?=	${DESTDIR}${LIBDIR}/libsepol.a
LIBSECOMPAT?=	${DESTDIR}${LIBDIR}/libsecompat.a
LIBSEMANAGE?=	${DESTDIR}${LIBDIR}/libsemanage.a
