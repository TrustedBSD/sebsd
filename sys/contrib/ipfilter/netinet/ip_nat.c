/*	$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_nat.c,v 1.40 2005/12/30 11:32:23 guido Exp $	*/
...
static const char rcsid[] = "@(#)$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_nat.c,v 1.40 2005/12/30 11:32:23 guido Exp $";
