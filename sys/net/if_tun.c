 ...
 * operation though.
 *
 * $FreeBSD: src/sys/net/if_tun.c,v 1.154 2005/08/09 10:19:58 rwatson Exp $
 */

#include "opt_atalk.h"
/*
 * XXXMAC: There's more MAC work to do here: right now, if_tun labels
 * packets generated by the interface, and does ifnet access control.
 * However, no attempt is made to use the credential opening or accessing
 * the tunnel device in the access control decision.  This needs to
 * be rectified.
 */
#include "opt_inet.h"
#include "opt_inet6.h"
